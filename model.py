...
class Seq2SeqTransformer(nn.Module):
    ...
    def forward(self, src: torch.Tensor, tgt: torch.Tensor, src_key_padding_mask: torch.Tensor = None, tgt_key_padding_mask: torch.Tensor = None, tgt_mask: torch.Tensor = None) -> torch.Tensor:
        ...
        out = self.transformer(src=src_pos, tgt=tgt_pos, src_key_padding_mask=src_key_padding_mask, tgt_key_padding_mask=tgt_key_padding_mask, tgt_mask=tgt_mask)
